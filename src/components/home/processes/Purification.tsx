					...
					<div className="grid justify-between h-full pt-4 w-full md:w-auto">
						<div className="space-y-4 text-center md:text-left">
							...
							<h2 className="text-lg md:text-xl text-[#000] font-bold">
								Removing impurities with precision.
							</h2>
							<p className="font-meta text-sm md:text-base max-w-[500px] mx-auto md:mx-0">
								Using advanced refining techniques, we meticulously remove
								impurities to achieve gold of the highest purity. Our
								cutting-edge technology ensures every batch is refined with
								unparalleled accuracy and care.
							</p>
